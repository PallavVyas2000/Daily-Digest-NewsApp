  ...
  render() {
    return (
      ...
      <div>
        <NavBar/>
        <Routes>
          <Route exact path="/"element ={<News key="home" pageSize = {21} country = {"in"}/>}/>                                            {/*if you dont add the key element in every route then you would need to manually refresh the page to see new content every time you clink on the nav buttons */}
          ...
          <Route exact path="/categories/general"element ={<News key="general" pageSize = {21} country = {"in"} category = "general"/>}/>
